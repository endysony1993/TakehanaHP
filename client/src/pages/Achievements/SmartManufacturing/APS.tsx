...
const galleryImages: string[] = [
  "/SmartManufacturing/aps/1.png",
  "/SmartManufacturing/aps/2.png",
  "/SmartManufacturing/aps/3.png",
]
                ...
                {galleryImages.map((src, idx) => (
                  <div key={src + idx} className="bg-white rounded-xl shadow overflow-hidden">
                    <div className="h-56 sm:h-64 lg:h-72 flex items-center justify-center bg-white p-2">
                      <img src={src} alt={`APS 画像 ${idx + 1}`} className="h-full max-h-full w-auto max-w-full object-contain" />
                    </div>
                  </div>
                ))}
              </div>
