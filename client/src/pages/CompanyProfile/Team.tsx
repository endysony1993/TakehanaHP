  ...
  return (
    <section className="py-16 bg-white min-h-[60vh]">
      <div className="max-w-5xl mx-auto px-4">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#034a8c] mb-8 text-center">チーム紹介</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded-xl shadow p-6">
            ...
            <h2 className="text-lg font-semibold text-[#034a8c]">何 剣</h2>
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded-xl shadow p-6">
            ...
            <h2 className="text-lg font-semibold text-[#034a8c]">李 明</h2>
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded-xl shadow p-6">
            ...
            <h2 className="text-lg font-semibold text-[#034a8c]">佐藤 花子</h2>
